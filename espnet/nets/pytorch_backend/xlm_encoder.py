...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def tie_weights(self):
        self.predict.weight = self.word_embed.weight

    def load_weight_from_bert(self, path):
        xlm_state = torch.load(path)
        self.word_embed.weight.data = xlm_state['transformer.embeddings.weight'].data
        self.position_embed.weight.data = xlm_state['transformer.position_embeddings.weight'].data
        self.lang_embed.weight.data = xlm_state['transformer.lang_embeddings.weight'].data
        self.embed_norm.weight.data = xlm_state['transformer.layer_norm_emb.weight'].data
        self.embed_norm.bias.data = xlm_state['bert.embeddings.layer_norm_emb.bias'].data
        for i in range(len(self.encoder)):
            self.encoder[i].self_attn.linear_q.weight.data = xlm_state['transformer.attentions.{}.q_lin.weight'.format(i)].data
            self.encoder[i].self_attn.linear_q.bias.data = xlm_state['transformer.attentions.{}.q_lin.bias'.format(i)].data
            self.encoder[i].self_attn.linear_k.weight.data = xlm_state['transformer.attentions.{}.k_lin.weight'.format(i)].data
            self.encoder[i].self_attn.linear_k.bias.data = xlm_state['transformer.attentions.{}.k_lin.bias'.format(i)].data
            self.encoder[i].self_attn.linear_v.weight.data = xlm_state['transformer.attentions.{}.v_lin.weight'.format(i)].data
            self.encoder[i].self_attn.linear_v.bias.data = xlm_state['transformer.attentions.{}.v_lin.bias'.format(i)].data
            self.encoder[i].self_attn.linear_out.weight.data = xlm_state['transformer.attentions.{}.out_lin.weight'.format(i)].data
            self.encoder[i].self_attn.linear_out.bias.data = xlm_state['transformer.attentions.{}.out_lin.bias'.format(i)].data
            self.encoder[i].feed_forward.w_1.weight.data = xlm_state['transformer.ffns.{}.lin1.weight'.format(i)].data
            self.encoder[i].feed_forward.w_1.bias.data = xlm_state['transformer.ffns.{}.lin1.bias'.format(i)].data
            self.encoder[i].feed_forward.w_2.weight.data = xlm_state['transformer.ffns.{}.lin2.weight'.format(i)].data
            self.encoder[i].feed_forward.w_2.bias.data = xlm_state['transformer.ffns.{}.lin2.bias'.format(i)].data
            self.encoder[i].norm1.weight.data = xlm_state['transformer.layer_norm1.{}.weight'.format(i)].data
            self.encoder[i].norm1.bias.data = xlm_state['transformer.layer_norm1.{}.bias'.format(i)].data
            self.encoder[i].norm2.weight.data = xlm_state['transformer.layer_norm2.{}.weight'.format(i)].data
            self.encoder[i].norm2.bias.data = xlm_state['transformer.layer_norm2.{}.bias'.format(i)].data
        self.predict.weight.data = xlm_state['pred_layer.proj.weight'].data
        self.predict.bias.data = xlm_state['pred_layer.proj.bias'].data
