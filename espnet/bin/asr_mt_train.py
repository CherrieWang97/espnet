...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument('--fbank-fmax', type=float, default=None,
                        help='')
    parser.add_argument('--tie-trg-weight', type=strtobool, default=True)
    parser.add_argument('--tie-src-weight', type=strtobool, default=False)
    parser.add_argument('--tie-src-ctc-weight', type=strtobool, default=False)
    return parser
...
def main(cmd_args):
    ...
    if args.num_spkrs == 1:
        if args.backend == "chainer":
            ...
            from espnet.asr.pytorch_backend.asr_mt import train
            train(args)
        else:
