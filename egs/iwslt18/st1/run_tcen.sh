...
st_ted=/teamscratch/tts_intern_experiment/v-chengw/data/iwslt18
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    ${cuda_cmd} --gpu ${ngpu} ${expdir}/train.log \
        ...
        --verbose ${verbose} \
        --resume ${resume} \
        --st-train-json ${feat_tr_dir}/data_${bpemode}${nbpe}.${case}.json \
        --asr-train-json /teamscratch/tts_intern_experiment/v-chengw/data/ted/dump/train/deltafalse/data_bpe1000.lc.rm.json \
        --mt-train-json /teamscratch/tts_intern_experiment/v-chengw/data/iwslt18/dump/train_nodevtest.de/data_bpe106.lc.rm_lc.json \
