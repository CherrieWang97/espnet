...
export PATH=~/espnet/tools/mwerSegmenter/:$MAIN_ROOT/tools/moses/scripts/tokenizer/:$MAIN_ROOT/tools/moses/scripts/generic/:$MAIN_ROOT/tools/sentencepiece/build/src:$PATH
